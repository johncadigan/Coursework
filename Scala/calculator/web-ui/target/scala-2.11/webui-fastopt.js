...
var $c_Lcalculator_Calculator$ = (function() {
  ...
  this.ValReg$1 = null;
  this.PlusReg$1 = null;
  this.MinusReg$1 = null;
  this.TimesReg$1 = null;
  this.DivideReg$1 = null
});
...
$c_Lcalculator_Calculator$.prototype.init___ = (function() {
  $n_Lcalculator_Calculator$ = this;
  this.NumReg$1 = "[0-9]+";
  this.VarReg$1 = "[a-j]";
  this.ValReg$1 = ((this.NumReg$1 + "|") + this.VarReg$1);
  this.PlusReg$1 = ((this.ValReg$1 + "\\+") + this.ValReg$1);
  this.MinusReg$1 = ((this.ValReg$1 + "\\-") + this.ValReg$1);
  this.TimesReg$1 = ((this.ValReg$1 + "\\*") + this.ValReg$1);
  this.DivideReg$1 = ((this.ValReg$1 + "\\*") + this.ValReg$1);
  return this
});
$c_Lcalculator_Calculator$.prototype.accumulateRefs__Lcalculator_Expr__sci_Map__sci_List__Z = (function(expr, references, acc) {
  _accumulateRefs: while (true) {
    var x1 = expr;
    if ($is_Lcalculator_Literal(x1)) {
      ...
      if ((elem$1 < 10)) {
        var temp$expr = $as_Lcalculator_Expr($as_Lcalculator_Signal(references.apply__O__O(name)).apply__O());
        var this$5 = acc;
        var this$4 = $m_sci_List$();
        var bf = this$4.ReusableCBFInstance$2;
        var temp$acc = $as_sci_List($s_sc_SeqLike$class__$$colon$plus__sc_SeqLike__O__scg_CanBuildFrom__O(this$5, name, bf));
        expr = temp$expr;
        acc = temp$acc;
        continue _accumulateRefs
      } else {
        return false
      }
      ...
      var a = x4.a$2;
      var b = x4.b$2;
      return (!(!(this.accumulateRefs__Lcalculator_Expr__sci_Map__sci_List__Z(a, references, acc) & this.accumulateRefs__Lcalculator_Expr__sci_Map__sci_List__Z(b, references, acc))))
    } else if ($is_Lcalculator_Minus(x1)) {
      var x5 = $as_Lcalculator_Minus(x1);
      var a$2 = x5.a$2;
      var b$2 = x5.b$2;
      return (!(!(this.accumulateRefs__Lcalculator_Expr__sci_Map__sci_List__Z(a$2, references, acc) & this.accumulateRefs__Lcalculator_Expr__sci_Map__sci_List__Z(b$2, references, acc))))
    } else if ($is_Lcalculator_Times(x1)) {
      var x6 = $as_Lcalculator_Times(x1);
      var a$3 = x6.a$2;
      var b$3 = x6.b$2;
      return (!(!(this.accumulateRefs__Lcalculator_Expr__sci_Map__sci_List__Z(a$3, references, acc) & this.accumulateRefs__Lcalculator_Expr__sci_Map__sci_List__Z(b$3, references, acc))))
    } else if ($is_Lcalculator_Divide(x1)) {
      var x7 = $as_Lcalculator_Divide(x1);
      var a$4 = x7.a$2;
      var b$4 = x7.b$2;
      return (!(!(this.accumulateRefs__Lcalculator_Expr__sci_Map__sci_List__Z(a$4, references, acc) & this.accumulateRefs__Lcalculator_Expr__sci_Map__sci_List__Z(b$4, references, acc))))
    } else {
...
$c_Lcalculator_Calculator$.prototype.computeValues__sci_Map__sci_Map = (function(namedExpressions) {
  var f = new $c_Lcalculator_Calculator$$anonfun$computeValues$2().init___sci_Map(namedExpressions);
  var this$1 = $m_sci_Map$();
  var bf = new $c_scg_GenMapFactory$MapCanBuildFrom().init___scg_GenMapFactory(this$1);
  var jsx$1 = $as_sci_Map($s_sci_MapLike$class__transform__sci_MapLike__F2__scg_CanBuildFrom__O(namedExpressions, f, bf));
  $m_Lcalculator_Signal$();
  var expr = new $c_sjsr_AnonFunction0().init___sjs_js_Function0((function() {
    return (NaN)
  }));
  return jsx$1.withDefaultValue__O__sci_Map(new $c_Lcalculator_Signal().init___F0(expr))
});
$c_Lcalculator_Calculator$.prototype.eval__Lcalculator_Expr__sci_Map__D = (function(expr, references) {
  _eval: while (true) {
    ...
    if ($is_Lcalculator_Literal(x1)) {
      ...
      var x3 = $as_Lcalculator_Ref(x1);
      var name = x3.name$2;
      var jsx$2 = $m_Lcalculator_Calculator$();
      var jsx$1 = expr;
      $m_sci_List$();
      var xs = new $c_sjs_js_WrappedArray().init___sjs_js_Array([name]);
      var this$2 = $m_sci_List$();
      var cbf = this$2.ReusableCBFInstance$2;
      if (jsx$2.accumulateRefs__Lcalculator_Expr__sci_Map__sci_List__Z(jsx$1, references, $as_sci_List($s_sc_TraversableLike$class__to__sc_TraversableLike__scg_CanBuildFrom__O(xs, cbf)))) {
        expr = $as_Lcalculator_Expr($as_Lcalculator_Signal(references.apply__O__O(name)).apply__O());
        continue _eval
      } else {
        var jsx$4 = $m_Lcalculator_Calculator$();
        var jsx$3 = expr;
        $m_sci_List$();
        var xs$1 = new $c_sjs_js_WrappedArray().init___sjs_js_Array([name]);
        var this$4 = $m_sci_List$();
        var cbf$1 = this$4.ReusableCBFInstance$2;
        if ((!jsx$4.accumulateRefs__Lcalculator_Expr__sci_Map__sci_List__Z(jsx$3, references, $as_sci_List($s_sc_TraversableLike$class__to__sc_TraversableLike__scg_CanBuildFrom__O(xs$1, cbf$1))))) {
          return (NaN)
        } else {
          return 0.0
        }
...
$c_Lcalculator_Polynomial$.prototype.computeSolutions__Lcalculator_Signal__Lcalculator_Signal__Lcalculator_Signal__Lcalculator_Signal__Lcalculator_Signal = (function(a, b, c, delta) {
  if (($uD(delta.apply__O()) < 0.0)) {
  ...
  } else if (($uD(a.apply__O()) === 0)) {
    $m_Lcalculator_Signal$();
    var expr$1 = new $c_sjsr_AnonFunction0().init___sjs_js_Function0((function() {
      var array$1 = [0.0];
      if (($uI(array$1["length"]) === 0)) {
        ...
        matchEnd4$1: {
          ...
          while ((i$1 < len$1)) {
            ...
            b$2.$$plus$eq__O__scm_SetBuilder(arg1$1);
            i$1 = ((1 + i$1) | 0)
          };
          break matchEnd4$1
        };
        var jsx$2 = $as_sc_GenTraversable(b$2.elems$1)
      };
    ...
    $m_Lcalculator_Signal$();
    var expr$2 = new $c_sjsr_AnonFunction0().init___sjs_js_Function0((function(a$2, b$2$1, delta$1) {
      return (function() {
        var jsx$6 = $uD(b$2$1.apply__O());
        var x = $uD(delta$1.apply__O());
        var jsx$5 = $uD($g["Math"]["sqrt"](x));
        var jsx$4 = $uD(a$2.apply__O());
        var jsx$3 = $uD(b$2$1.apply__O());
        var x$1 = $uD(delta$1.apply__O());
        var array$2 = [(((-jsx$6) - jsx$5) / (2 * jsx$4)), (((-jsx$3) + $uD($g["Math"]["sqrt"](x$1))) / (2 * $uD(a$2.apply__O())))];
        if (($uI(array$2["length"]) === 0)) {
          ...
          matchEnd4$2: {
            ...
            while ((i$2 < len$2)) {
              ...
              b$3.$$plus$eq__O__scm_SetBuilder(arg1$2);
              i$2 = ((1 + i$2) | 0)
            };
            break matchEnd4$2
          };
          var jsx$7 = $as_sc_GenTraversable(b$3.elems$1)
        };
...
$c_Lcalculator_TweetLength$.prototype.colorForRemainingCharsCount__Lcalculator_Signal__Lcalculator_Signal = (function(remainingCharsCount) {
  if (($uI(remainingCharsCount.apply__O()) < 0)) {
    var expr = new $c_sjsr_AnonFunction0().init___sjs_js_Function0((function() {
      return "red"
    }));
    return new $c_Lcalculator_Var().init___F0(expr)
  } else if (($uI(remainingCharsCount.apply__O()) > 14)) {
    var expr$1 = new $c_sjsr_AnonFunction0().init___sjs_js_Function0((function() {
      return "green"
    }));
    return new $c_Lcalculator_Var().init___F0(expr$1)
  } else {
    var expr$2 = new $c_sjsr_AnonFunction0().init___sjs_js_Function0((function() {
      return "orange"
    }));
    return new $c_Lcalculator_Var().init___F0(expr$2)
  }
});
...
var $s_sci_Map$class__withDefaultValue__sci_Map__O__sci_Map = (function($$this, d) {
...
var $s_sci_MapLike$class__transform__sci_MapLike__F2__scg_CanBuildFrom__O = (function($$this, f, bf) {
  ...
  new $c_sc_TraversableLike$WithFilter().init___sc_TraversableLike__F1($$this, p).foreach__F1__V(new $c_sjsr_AnonFunction1().init___sjs_js_Function1((function($$this$2, b$1, f$1) {
    return (function(x$4$2) {
      var x$4 = $as_T2(x$4$2);
      if ((x$4 !== null)) {
        var key = x$4.$$und1$f;
        var value = x$4.$$und2$f;
        return b$1.$$plus$eq__O__scm_Builder(new $c_T2().init___O__O(key, f$1.apply__O__O__O(key, value)))
      } else {
...
$c_Lcalculator_Calculator$$anonfun$computeValues$2.prototype = new $h_sr_AbstractFunction2();
...
$c_Lcalculator_Calculator$$anonfun$computeValues$2.prototype.apply__T__Lcalculator_Signal__Lcalculator_Signal = (function(k, v) {
  var jsx$3 = $m_Lcalculator_Calculator$();
  var jsx$2 = $as_Lcalculator_Expr(v.apply__O());
  var jsx$1 = this.namedExpressions$1$f;
  $m_sci_List$();
  var xs = new $c_sjs_js_WrappedArray().init___sjs_js_Array([k]);
  var this$2 = $m_sci_List$();
  var cbf = this$2.ReusableCBFInstance$2;
  if (jsx$3.accumulateRefs__Lcalculator_Expr__sci_Map__sci_List__Z(jsx$2, jsx$1, $as_sci_List($s_sc_TraversableLike$class__to__sc_TraversableLike__scg_CanBuildFrom__O(xs, cbf)))) {
    $m_Lcalculator_Signal$();
    var expr = new $c_sjsr_AnonFunction0().init___sjs_js_Function0((function(arg$outer, k$1) {
      return (function() {
        return $m_Lcalculator_Calculator$().eval__Lcalculator_Expr__sci_Map__D($as_Lcalculator_Expr($as_Lcalculator_Signal(arg$outer.namedExpressions$1$f.apply__O__O(k$1)).apply__O()), arg$outer.namedExpressions$1$f)
      })
    })(this, k));
    return new $c_Lcalculator_Signal().init___F0(expr)
  } else {
...
$c_Lcalculator_Calculator$$anonfun$computeValues$2.prototype.apply__O__O__O = (function(v1, v2) {
  return this.apply__T__Lcalculator_Signal__Lcalculator_Signal($as_T(v1), $as_Lcalculator_Signal(v2))
});
...
/** @constructor */
var $c_sc_Map$WithDefault = (function() {
...
/** @constructor */
var $h_sc_Map$WithDefault = (function() {
  /*<skip>*/
});
...
$c_sci_AbstractMap.prototype.withDefaultValue__O__sci_Map = (function(d) {
  return $s_sci_Map$class__withDefaultValue__sci_Map__O__sci_Map(this, d)
});
...
/** @constructor */
var $c_sci_Map$WithDefault = (function() {
...
/** @constructor */
var $h_sci_Map$WithDefault = (function() {
  /*<skip>*/
});
...
$c_sci_Map$WithDefault.prototype.withDefaultValue__O__sci_Map = (function(d) {
  return new $c_sci_Map$WithDefault().init___sci_Map__F1(this.underlying$5, new $c_sjsr_AnonFunction1().init___sjs_js_Function1((function(this$2, d$1) {
    return (function(x$2) {
      return d$1
    })
  })(this, d)))
...
$c_sci_Map$WithDefault.prototype.toMap__s_Predef$$less$colon$less__sci_Map = (function(ev) {
  return this
});
...
var $d_sci_Map$WithDefault = new $ClassTypeData({
